...
class BaseAviary(gym.Env):
    ...
    def __init__(
        ...
        # Segmentation is rendered by default for backward compatibility, but
        # it is a full extra render pass and most callers discard it.
    ...
    def _getDroneImages(self, nth_drone):
        ...
        2. ``self._render_seg`` False -> skip the segmentation render pass and
           return a zero segmentation buffer. Saves a full pass for the many
